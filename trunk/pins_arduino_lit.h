...
#define PORT_AT_PIN_4       PortG   // PG 5 ** 4 ** P   WM4 
...
/* not __AVR_ATmega1280__ */

#elif defined(__AVR_ATmega128__)// for 128  
#define PORT_AT_PIN_0 PortA
#define PORT_AT_PIN_1 PortA
#define PORT_AT_PIN_2 PortG
#define PORT_AT_PIN_3 PortC
#define PORT_AT_PIN_4 PortC
#define PORT_AT_PIN_5 PortC
#define PORT_AT_PIN_6 PortC
#define PORT_AT_PIN_7 PortG
#define PORT_AT_PIN_8 PortD
#define PORT_AT_PIN_9 PortD
#define PORT_AT_PIN_10 PortD
#define PORT_AT_PIN_11 PortD
#define PORT_AT_PIN_12 PortG
#define PORT_AT_PIN_13 PortB
#define PORT_AT_PIN_14 PortA
#define PORT_AT_PIN_15 PortA
#define PORT_AT_PIN_16 PortA
#define PORT_AT_PIN_17 PortC
#define PORT_AT_PIN_18 PortC
#define PORT_AT_PIN_19 PortC
#define PORT_AT_PIN_20 PortC
#define PORT_AT_PIN_21 PortG
#define PORT_AT_PIN_22 PortD
#define PORT_AT_PIN_23 PortD
#define PORT_AT_PIN_24 PortD
#define PORT_AT_PIN_25 PortD
#define PORT_AT_PIN_26 PortG
#define PORT_AT_PIN_27 PortA
#define PORT_AT_PIN_28 PortA
#define PORT_AT_PIN_29 PortF
#define PORT_AT_PIN_30 PortF
#define PORT_AT_PIN_31 PortF
#define PORT_AT_PIN_32 PortF
#define PORT_AT_PIN_33 PortE
#define PORT_AT_PIN_34 PortE
#define PORT_AT_PIN_35 PortE
#define PORT_AT_PIN_36 PortE
#define PORT_AT_PIN_37 PortB
#define PORT_AT_PIN_38 PortB
#define PORT_AT_PIN_39 PortB
#define PORT_AT_PIN_40 PortA
#define PORT_AT_PIN_41 PortF
#define PORT_AT_PIN_42 PortF
#define PORT_AT_PIN_43 PortF
#define PORT_AT_PIN_44 PortF
#define PORT_AT_PIN_45 PortE
#define PORT_AT_PIN_46 PortE
#define PORT_AT_PIN_47 PortE
#define PORT_AT_PIN_48 PortE
#define PORT_AT_PIN_49 PortB
#define PORT_AT_PIN_50 PortB
#define PORT_AT_PIN_51 PortB
#define PORT_AT_PIN_52 PortB
#define PORTMSK_AT_PIN_0  _BV(4)
#define PORTMSK_AT_PIN_1  _BV(6)
#define PORTMSK_AT_PIN_2  _BV(2)
#define PORTMSK_AT_PIN_3  _BV(6)
#define PORTMSK_AT_PIN_4  _BV(4)
#define PORTMSK_AT_PIN_5  _BV(2)
#define PORTMSK_AT_PIN_6  _BV(0)
#define PORTMSK_AT_PIN_7  _BV(0)
#define PORTMSK_AT_PIN_8  _BV(6)
#define PORTMSK_AT_PIN_9  _BV(4)
#define PORTMSK_AT_PIN_10  _BV(2)
#define PORTMSK_AT_PIN_11  _BV(0)
#define PORTMSK_AT_PIN_12  _BV(4)
#define PORTMSK_AT_PIN_13  _BV(7)
#define PORTMSK_AT_PIN_14  _BV(3)
#define PORTMSK_AT_PIN_15  _BV(5)
#define PORTMSK_AT_PIN_16  _BV(7)
#define PORTMSK_AT_PIN_17  _BV(7)
#define PORTMSK_AT_PIN_18  _BV(5)
#define PORTMSK_AT_PIN_19  _BV(3)
#define PORTMSK_AT_PIN_20  _BV(1)
#define PORTMSK_AT_PIN_21  _BV(1)
#define PORTMSK_AT_PIN_22  _BV(7)
#define PORTMSK_AT_PIN_23  _BV(5)
#define PORTMSK_AT_PIN_24  _BV(3)
#define PORTMSK_AT_PIN_25  _BV(1)
#define PORTMSK_AT_PIN_26  _BV(3)
#define PORTMSK_AT_PIN_27  _BV(2)
#define PORTMSK_AT_PIN_28  _BV(0)
#define PORTMSK_AT_PIN_29  _BV(6)
#define PORTMSK_AT_PIN_30  _BV(4)
#define PORTMSK_AT_PIN_31  _BV(2)
#define PORTMSK_AT_PIN_32  _BV(0)
#define PORTMSK_AT_PIN_33  _BV(1)
#define PORTMSK_AT_PIN_34  _BV(3)
#define PORTMSK_AT_PIN_35  _BV(5)
#define PORTMSK_AT_PIN_36  _BV(7)
#define PORTMSK_AT_PIN_37  _BV(1)
#define PORTMSK_AT_PIN_38  _BV(3)
#define PORTMSK_AT_PIN_39  _BV(5)
#define PORTMSK_AT_PIN_40  _BV(1)
#define PORTMSK_AT_PIN_41  _BV(7)
#define PORTMSK_AT_PIN_42  _BV(5)
#define PORTMSK_AT_PIN_43  _BV(3)
#define PORTMSK_AT_PIN_44  _BV(1)
#define PORTMSK_AT_PIN_45  _BV(0)
#define PORTMSK_AT_PIN_46  _BV(2)
#define PORTMSK_AT_PIN_47  _BV(4)
#define PORTMSK_AT_PIN_48  _BV(6)
#define PORTMSK_AT_PIN_49  _BV(0)
#define PORTMSK_AT_PIN_50  _BV(2)
#define PORTMSK_AT_PIN_51  _BV(4)
#define PORTMSK_AT_PIN_52  _BV(6)


////////////Arduino pin to Timer Regs mapping
#define TIMER_AT_PIN_47   3B
#define TCCR_AT_PIN_47    TCCR3A

#define TIMER_AT_PIN_48   3C
#define TCCR_AT_PIN_48    TCCR3A

#define TIMER_AT_PIN_34   3A 
#define TCCR_AT_PIN_34    TCCR3A

#define TIMER_AT_PIN_39  1A
#define TCCR_AT_PIN_39   TCCR1A

#define TIMER_AT_PIN_52  1B
#define TCCR_AT_PIN_52   TCCR1A

#define TIMER_AT_PIN_13  1C
#define TCCR_AT_PIN_13   TCCR1A

//#define TIMER_AT_PIN_13  2
//#define TCCR_AT_PIN_13   TCCR2
