...
(uint8_t)(uint16_t)	&DDRE,
(uint8_t)(uint16_t)	&DDRF,
(uint8_t)(uint16_t)	&DDRG
};
...
(uint8_t)(uint16_t)	&PORTD,
	(uint8_t)(uint16_t)&PORTE,
	(uint8_t)(uint16_t)&PORTF,
(uint8_t)(uint16_t)	&PORTG
};
...
const uint8_t PROGMEM port_to_input_PGM[] = {
	...
	(uint8_t)(uint16_t)&PINE,
	(uint8_t)(uint16_t)&PINF,
	(uint8_t)(uint16_t)&PING
};
